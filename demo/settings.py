...
SECRET_KEY = 'django-insecure-_)2wg-jksocbhozt)kez9xt(22$9s@x6^06g$6d9h2j3rm()2='
...
# группы скидок для фильтрации из задания
SKIDKA_RANGES = [
    (0, 10),
    (10, 20),
    (20, 30),
...
# макс. размер фото товара при сохранении (ширина, высота)
